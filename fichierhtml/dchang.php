...
?>
    ...
    <div>
        ...
        <div class="ligne1">
            <p><a href="../fichierhtml/lettre.php">lettre_de_recommandation </a></p>
        </div>
        <div class="ligne1">
    ...
    <article id="ligne4">
        <h3 id="titreDemande">Demande du changement du groupe</h3>
        <form method="post" action="traitement_demande.php" onsubmit="prepareDemande()">
