...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $requeteResponsable = "SELECT * FROM chef_filiere WHERE Email_Chef_Filiere = '$email' AND Id_Chef_Filiere = '$motdepasse'";
    ...
    if ($resultatResponsable) {
        ...
        if ($rowResponsable) {
            ...
            $_SESSION["email"] = $rowResponsable[" Email_Chef_Filiere"];
            $_SESSION["nom_responsable"] = $rowResponsable["Nom_Chef_Filiere"];
            $_SESSION["prenom_responsable"] = $rowResponsable["Prenom_Chef_Filiere"];
            $_SESSION["id_responsable"] = $rowResponsable["Id_Chef_Filiere"];
           

            header("Location:EspaceResFiliere.php");
            exit();
        } else {
...
<body>
  <div class="container">
    <div class="header">
      <h2 align="center"> Espace-chef-filiere</h2>
    </div>
    <form id="form" class="form" method="post" action="loginfiliere.php">
