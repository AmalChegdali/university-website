...
// Paramètres de connexion à la base de données (à adapter selon vos paramètres)
$serveur = "localhost";
$utilisateur = "root";
$motdepasse = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $requeteResponsable = "SELECT * FROM chef_Departement WHERE Email_Chef_Departement = '$email' AND Id_Chef_Departement = '$motdepasse'";
    ...
    if ($resultatResponsable) {
        ...
        if ($rowResponsable) {
            ...
            $_SESSION["email"] = $rowResponsable[" Email_Chef_Departement"];
            $_SESSION["nom_responsable"] = $rowResponsable["Nom_Chef_Departement"];
            $_SESSION["prenom_responsable"] = $rowResponsable["Prenom_Chef_Departement"];
            $_SESSION["id_responsable"] = $rowResponsable["Id_Departement"];
          
            header("Location:EspaceChefDepar.php");
            exit();
        } else {
...
<body>
  <div class="container">
    <div class="header">
      <h2 align="center"> Espace-chef-Département</h2>
    </div>
    <form id="form" class="form" method="post" action="loginchefdepart.php">
